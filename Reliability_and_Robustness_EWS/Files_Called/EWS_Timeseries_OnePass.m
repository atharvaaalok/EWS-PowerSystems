function [EWS_details, RateRMS_details] = EWS_Timeseries_OnePass(time, state_timeseries, parameter_variation, delta_t, window_size, window_step)
...
rms_timeseries = moving_rms(state_timeseries, window_size, window_step);
var_timeseries = moving_variance(state_timeseries, window_size, window_step);
sk_timeseries = moving_skewness(state_timeseries, window_size, window_step);
kr_timeseries = moving_kurtosis(state_timeseries, window_size, window_step);

AC_timeseries = moving_autocorr(state_timeseries, window_size, window_step, AC_lag);
